...
| [jev](./jev/) | MCP server for the Jev API (TypeSafe AI) that returns structured choice, score, and boolean decisions with confidence | **MCP server:** `jev` with the `jev_evaluate` tool for classification, routing, and rubric grading |
